...
export default function Home() {
    const tempArr = [
        {
            description: "Ai feature ui has been completed",
            category: "Medium",
            issuer: "kamran@yopmail.com",
            checked: false,
            editable: false
        },
        {
            description: "Notification ui has been updated",
            category: "Critical",
            issuer: "Issuer@yopmail.com",
            checked: false,
            editable: false
        },
        {
            description: "Compay report crash issue has been fixed",
            category: "Medium",
            issuer: "Test@yopmail.com",
            checked: false,
            editable: false
        },
        {
            description: "Ui issues resolved on mobile view",
            category: "Urgent",
            issuer: "Zarrar@yopmail.com",
            checked: false,
            editable: false
        },
    ]
            ...
            {/* <Modal isOpen={modal} toggle={() => setModal(false)} size='lg'>
                        ...
                        <div className='row'>
                            <div className='col-md-6'>
                                ...
                                <input
                                    ...
                                    value={desc || valueEdited?.description}
                                    onChange={(e) => {
                            ...
                            <div className='col-md-6'>
                                ...
                                <select value={category || valueEdited?.category} onChange={(e) => setCategory(e.target.value)} class="form-control" aria-label="Default select example">
                            ...
                            <div className='col-12'>
                                ...
                                <input
                                    ...
                                    value={issuerEmail || valueEdited?.issuer}
                                    onChange={(e) => {
                ...
                <ModalFooter>
                    <Button
                        color='success'
                        onClick={() => {
                            const findIndex = notes.findIndex((ele) => ele?.issuer == valueEdited?.issuer)
                            if(valueEdited){
                                setNotes([
                                    ...notes?.slice(0,findIndex), {
                                    description: desc || valueEdited?.description,
                                    category: category || valueEdited?.category,
                                    issuer: issuerEmail || valueEdited?.issuerEmail,
                                    checked: false ,
                                    editable: false
                                },
            ...
            {/* <div className='card'>
                <div
                    ...
                    <div className='col-12 px-0'>
                        <div className='col-12 px-0'>
                            <div
                                className='d-flex bordered rounded py-3'>
                                <div
                                    className='col-10'
                                >
                                    <input
                                        ...
                                        onChange={(e) => {
                                            ...
                                            if(value){
                                                let temp = notes
                                                setNotes(temp?.filter((item) => item?.category?.toLocaleLowerCase().includes(value?.toLowerCase()) || item?.issuer?.toLocaleLowerCase().includes(value?.toLowerCase())))
                                            }
                                            else{
                                                setNotes(tempArr)
                                            }
                        ...
                        <div className='col-12 d-flex flex-wrap'>
                            {notes?.map((item, index) => {
                                return (
                                    <div style={{
                                        minHeight: "20vh"
                                    }} className='rounded border col-md-3 p-3 mx-2 mb-3'>
                                        <div className='d-flex mb-3 justify-content-between align-items-center'>
                                            <div
                                                style={{
                                                    backgroundColor:
                                                        notes[index]?.checked ? "black" :
                                                            item?.category?.toLowerCase() == "urgent" ? "#EE4E4E" :
                                                                item?.category?.toLowerCase() == "medium" ? '#3ABEF9' : "orange",
                                                    borderRadius: "20px",
                                                    color: "white",
                                                    width: "max-content",
                                                }}
                                            ...
                                            <div>
                                                ...
                                                <svg
                                                    onClick={() => {
                                                        setNotes(notes?.filter((ele, index1) => index1 !== index))
                                                    }}
                                                    style={{
                                                        cursor: "pointer"
                                                    }}
